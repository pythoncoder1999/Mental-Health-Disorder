...
def transform():
   ...
   # print(294/(60186-46662)) #<5%
    ...
    #print(i['Have you been diagnosed with a mental health condition by a medical professional'].value_counts())
    #print(i['Have you been diagnosed with a mental health condition by a medical professional'].isnull().sum())
