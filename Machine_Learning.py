...
r = RandomForestClassifier(max_depth = 20,min_samples_split=10, random_state=5)
...
n2 = RandomForestClassifier(max_depth=15, min_samples_split=10, random_state=5)
...
n = RandomForestRegressor(max_depth=20, min_samples_split=10, random_state=5)
